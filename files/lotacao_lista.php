...
<script language="Javascript">
   ...
   <table width="435" align="center" class="table table-striped" style="font-size: 12px" >
               ...
               <tr  style='font-weight:bold;'>
                 ...
                 <td ><div align="center">Nascimento</div></td>
                 <td ><div align="center">Data Cadastro</div></td>
                ...
                error_reporting(E_ALL ^ E_NOTICE);
                  ...
                  while($registro = $stmt1->fetch(PDO::FETCH_ASSOC)){
                                      ...
                                      <div id='ticket'> 
                                        <strong> 
                                         ...
                                         if (isset($_GET['ativo']) || isset($_GET['fechado']) ) {
                                            echo "principal.php?id=".$registro["id"]."&prontuario";
                                         }else{
                                            echo "validar_matricula.php?cpf=".$registro["cpf"]."&cadastro=".$registro["id"];
                                         }
                         ...
                         echo"            
                                    ...
                                    <td ><div align='center' >".date("j/n/Y",strtotime($registro["data_prontuario"]))."</div></td>
                                    <td ><div align='center' >";
    ...
    <!-- NAVEGA ENTRE AS PÁGINAS NUMERADAS -->
              <?php 
                ...
                for ($i=1; $i < $num_paginas+1; $i++) {
                 ...
                 echo '<li class="page-item"><a class="page-link" href="principal.php?paciente=1&pagina='.$pagina.'"><b>'. $i .'</b></a></li>';
                $pagina = $registro2;
                }
              ?>
    <!-- REMETE PARA O ULTIMO REGISTRO -->            
              <li class="page-item">
                <a class="glyphicon glyphicon-fast-forward"  href="principal.php?paciente=1&ultima_pagina=<?php echo $ultima_pagina; ?>" aria-label="Next">          
                </a>
              </li> 
            </ul>
      </nav>
