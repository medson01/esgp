...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" style="margin-left:10%; width:50%">
          ...
          <table width="100% " border="0" align="center">
            <tr>
              <td colspan="3" bgcolor="#CCCCCC"><div align="center" class="style5"> <br />
                  <span class="style2">DEFINI&Ccedil;&Atilde;O DE CARGOS E FUN&Ccedil;&Otilde;ES</span> <br />
                <br />
                <br />
</div></td>
            </tr>
			...
			<tr>
              <td colspan="3" bgcolor="#FF0033"><div align="center" class="style5"> 
                <p><br />
                  &Eacute; necess&aacute;rio ap&oacute;s cadastrar os par&acirc;metros dos cargos aqui,  tamb&eacute;m fazer o mesmo no <a href="https://sislameal.caedufjf.net/sislameal/login.faces" target="_blank" class="style3">Sistema Sislame</a> para os dois ficarem iguais.     <br />
                  Esse Sistema serve de suporte ao Sislame, apresentando a informa&ccedil;&atilde;o para o gestor. <br />
                  <br />
                  </p>
              </div></td>
            </tr>
		  <tr border="1" >
		  	<td style="color:#000000"><h2>CARGO/ FUN&Ccedil;&Atilde;O EXISTE</h1></td>
			<td style="color:#000000"><h2>QUANTIDADE</h2></td>
			<td colspan="10" style="color:#000000"><h2>EXCLUIR</h2></td>
    ...
    //echo '<textarea id="quadro_clinico" name="quadro_clinico" rows="18" cols="50" disabled="" required="required" style="font-size: 16px; color: green;" >';
    echo " \n";
				$i= 0;
				$qtd_funcao = 0;
                 while($registro = $stmt->fetch(PDO::FETCH_ASSOC)){
					...
					echo '<tr>
						  	...
						  	<td>
								...
								<center>
									<input style="width: 20px; height: 20px; margin-top: -10px;" type="checkbox" class="form-check-input" id="excluir" name="exclui"  > 
								</center>
							</td>
							<td></td>/
							<td></td>
