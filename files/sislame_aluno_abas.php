...
if( empty($_GET['registro']) && !isset($_GET['novo']) ){
      ...
      <!-- /ABA -->				
      		...
      		<ul class="nav nav-tabs" style="clear: left;width: 98%;margin-left: 1%;">
      			<li class="nav-item  active">
      					<a class="nav-link active" href="#1" data-toggle="tab" aria-expanded="true"> Aluno </a>
      			</li>
				<li class="nav-item ">
      		...
      		<div class="tab-content ">
      			<div class="tab-pane fade active in" role="tabpanel" id="1">      	';
					include"sislame_aluno_lista.php";
    echo'		</div>
	...
	echo'
      ...
      <!-- /ABA -->				
      		...
      		<ul class="nav nav-tabs" style="clear: left;width: 98%;margin-left: 1%;">
      			<li class="nav-item">
      					<a class="nav-link " href="#1" data-toggle="tab" aria-expanded="true"> Aluno </a>
      			</li>
				<li class="nav-item   active">
    ...
    echo'		</div>
				<div class="tab-pane fade active in" role="tabpanel" id="2">      			';
					include"sislame_aluno_formulario.php";
    echo'		</div>
			</div>			
    	</div>
    ';
