...
-->
  ...
  <div class="panel-heading" style="background-color: lightslategray; color: #f3eded; text-align:center"> <strong> Fisioterapia </strong> </div>
  ...
  <?php
			  	//	if(!empty($_GET['prontuario'])){
					     include("evol_fisioterapia_formulario.php");
